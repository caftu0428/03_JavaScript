...
function pow(num, x){
    ...
    let result = 1; // 곱했을 때 결과에 영향을 주기 않기 위해 1 초기화
...
function twoNumberPlus( otherFn){
    ...
    const input4 = Number(prompt("네 번째 값"));

    alert(otherFn(input1, input2, input3, input4 ));
}
