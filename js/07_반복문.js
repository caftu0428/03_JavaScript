function check1(){
    ...
    //     [3]조건신이 true인 경우 반복 수행할 코드;
    // }

    let result = ""; //빈 문자열
    for(let num=1 ; num <= 5 ; num++){

        result += num; // 복합 대임 연산자
        // result = reuslt = num;
...
function check6(){
    ...
    let sum = 0; // 합계를 저장하기 위한
                 // 0을 대입한 이유 : 0은 더해도 아런 영항이 없기 때문에
