...
openPopup1.addEventListener("click", ()=> {
    window.open("23_STOP WATCH.html");
...
openPopup2.addEventListener("click", ()=> {
    window.open("23_STOP WATCH.html", "_blank", "popup");
});
...
openPopup3.addEventListener("click", () => {
  ...
  // 단, 메인 모니터에서만 적용됨
    ...
    window.open("23_STOP WATCH.html", "_blank", "popup", options.toString());
});


/* 팝업창(자식)이 부모차의 값을 읽고/쓰기 */
