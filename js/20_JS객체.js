...
btn1.addEventListener("click", ()=>{
    ...
    //-------------------------------------
    // 2. 객체 내 key 값을 이용해 원하는 value 얻어고
...
btn2.addEventListener("click",()=>{
    ...
    smartPhone.modelName = "아이포15프로맥스";
...
//    };
  ...
  // };
   ...
   const student2 = new Student("길철수",1,2,3, 100);
