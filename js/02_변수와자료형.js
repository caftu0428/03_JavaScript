/* console.log(값) */
// 브라우저 콘솔에 괄호() 내부에 값을 기록(출력)

console.log(1234);
console.log("문자열은 양쏙에 쌍따옴표를 작성해야 한다!");

console.log('JS는 홑따옴표도 문자열로 취깁한다!');
...
// 1. var (변수, 변수 선언 식 중복되는 변수명으로 선언 가능)
...
// 변수명 중복 오류 발생!
// let number3 = 500; //'numver3'을(를) 다시 선언할 수 없습니다.


number3 =500; // 기존 변수 bumber3에 새로운 값만 대입
...
/* undefined : 정의되지 않은 변수/ 값이 아직 대입되 않았다 */
let undef; // 변수 선언
...
console.log("isTrus : ", isTrue, typeof isTrue);
...
// V(value) : K에 대응되는 값(변수에 대입된 값 비슷)
